		...
		<div class="row gtr-uniform">
			...
			<div class="col-6 col-12-medium">
				<ul class="alt" style="border: 1px solid; padding: 10px; box-shadow: 5px 10px #888888;">
					...
					<li>Address : <b>
							<?php echo $users['address1']; ?>
						</b></li>
					<li>Postcode: <b>
							<?php echo $users['postcode']; ?>
						</b></li>
					<li><br><input type="button" class="button fit" onclick="location.href='editAccount.php';"
							value="Edit Account" /></li>
				</ul>
			</div>
		</div>
	</div>
