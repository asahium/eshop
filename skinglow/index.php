...
<?php include('inc/header.php');?>
				<!-- Main -->
				<head><title>Smile Slimes | Home</title></head>
					<div id="main">
						<div class="inner" id="products">
							<header>
								<h2>SMILE SLIMES </h2>
								<p> Dive into a world of colorful, squishy wonders at Smile Slime! We are thrilled to present a mesmerizing collection of slimes that will surely bring a smile to your face. Whether you're a seasoned slime enthusiast or a curious first-timer, our online shop offers an enchanting array of slimes that cater to every age and preference.
									<br> Let your imagination run wild and shop now at Smile Slime – where enchantment meets squishy fun!</p>
							</header>
							...
							<div class="box alt">
										<div class="row gtr-uniform">
											...
											<input type="button" class="button fit" onclick="location.href='ourProduct.php';" value="See our Slimes!" />
                                            </div>
										</div>
									</div>
						</div>
