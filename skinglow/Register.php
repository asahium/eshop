...
<head>
	<title>Smile Slimes | Registeration</title>
</head>
<div id="main">
	<div class="inner">
			...
			<div class="container">
				<form action="" method="POST" class="login-email">
					...
					<div class="row gtr-uniform">
						...
						<div class="col-12">
							<input type="password" name="password" id="psw" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required />
						</div>
						<div class="col-12">
							<input type="password" name="cpassword" id="psw" placeholder="Confirm Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required />
						</div>
						...
						<p class="login-register-text">Have an account? <a href="<?php echo ROOT_URL; ?>logout.php">Login Here</a>.</p>
				</form>
			</div>
		</div>
	</div>
