...
<head>
    <title>Smile Slimes | Edit Profile</title>
</head>
<div id="main">
    <div class="inner">
        ...
        <div>
            <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                <div class="row gtr-uniform">
                    ...
                    <div class="col-12">
                        <input type="text" name="uname" id="uname" value="<?php echo $user['uname']; ?>"
                    ...
                    <div class="col-12">
                        <input type="tel" name="phone" id="phone" pattern="[0-9]+" title="number only"
                    ...
                    <div class="col-6 col-12-xsmall">
                        <input type="text" name="address1" id="address1" value="<?php echo $user['address1']; ?>"
                            placeholder="Address" />
                    </div>
                    <div class="col-6 col-12-xsmall">
                        <input type="text" name="postcode" id="postcode" pattern="[0-9]+" title="number only"
                            value="<?php echo $user['postcode']; ?>" placeholder="Postcode" />
                    </div>
                    <div class="col-6 col-12-xsmall">
                        <label>Birthday
